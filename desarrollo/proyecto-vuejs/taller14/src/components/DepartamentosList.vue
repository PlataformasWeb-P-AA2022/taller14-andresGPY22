                ...
                <div class="row no-gutters">
                    <div class="col-md-4">
                        <div class="card-body">
                            ...
                            <br>
                            <span class="card-text"><b>Número de Cuartos:</b> {{ departamento.cuartos }}</span>
                            <br>
                            <span class="card-title"><b>Número de Baños:</b> {{ departamento.banios }}</span>
                            <br>
                            <span class="card-title"><b>Valor de Alícuota:</b> {{ departamento.alicuota }}</span>
                            <br>
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            <span class="card-text"><b>Propietario:</b> {{ departamento.estudiante_str }}</span>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <p  v-if="departamentos.length == 0"> Sin Telefonos</p>
    </div>
</template>
<script>
